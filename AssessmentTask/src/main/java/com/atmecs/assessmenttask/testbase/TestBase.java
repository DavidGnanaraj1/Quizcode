package com.atmecs.assessmenttask.testbase;
...
/**
 * This Class reads browser name and url from the config.properties file
 * and select the browser accordingly and also get the url,maximize the window,implicit wait
 */
